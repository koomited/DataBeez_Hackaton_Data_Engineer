...
@dag(
    dag_id="senegal_weather_etl_pipeline_v1",
...
def extract_transform_load_weather_data():
    ...
    @task_group(group_id="api_group_call")
    def extract_save(coordinates:list):
        @task
        def extract_weather_data(coordinates:list):
        ...
        weather_data = extract_weather_data(coordinates)
        ...
        load_to_posgres = load_weather_data(transformed_data)
        
        # set dependencies
        weather_data >> transformed_data >> load_to_posgres
        
    extract_save.expand(coordinates=[[LATITUDE_DAKAR, LONGITUDE_DAKAR], 
                                [LATITUDE_THIES, LONGITUDE_THIES]])
